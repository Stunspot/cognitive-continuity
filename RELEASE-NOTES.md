...
- commit: `550da0734566d97f69c5b6a85fa4dc88a6c0eb20`
...
- Accepts maintained v1 0.2.0 manifest extensions and valid full-date effective values. Explicit copy migration maps those dates to equivalent UTC-midnight timestamps in the successor and binds the normalization count and digest without mutating the source.
